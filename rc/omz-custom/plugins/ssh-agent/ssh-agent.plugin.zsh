...
#   your .zshrc file: (rufus63: code looks for "yes"???)
#
...
if [[ ${_plugin__forwarding} == "yes" ]]; then
  # Add a nifty symlink for screen/tmux if agent forwarding
  # Redefine the environment variable to the link itself
  # so shells can continue to authenticate when the link
  # is changed later.
